...
# Hospital wards in Figure 7. To represent over-occupancy, we place one extra patient at each corridor zone, leading to 21 patients
N=21
# There are 9 ventilation zones
M=9
# All 9 zones have patients
Mreal=9
...
# 1 extra patient at each corridor area
Ni[2]=1.0
Ni[5]=1.0
Ni[8]=1.0
...
# We explore initial positions 1a, c1, c2 or c3 in Table X
initial_infective_positions=[0,2,5,8]
...
for regime_index in range(6):
		...
		for initial_infective_index in range(4):
			...
			# We implement a recursive scheme for Algorithm 1, n=0
			nmax=20
